 ...
 */
final class Version20210126103753 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bet (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, competition_id INT NOT NULL, run_id INT DEFAULT NULL, team_id INT DEFAULT NULL, team_member_id INT DEFAULT NULL, bet_category_id INT NOT NULL, designation VARCHAR(255) NOT NULL, amount INT NOT NULL, odds INT NOT NULL, is_winning TINYINT(1) DEFAULT NULL, bet_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_FBF0EC9BA76ED395 (user_id), UNIQUE INDEX UNIQ_FBF0EC9B7B39D312 (competition_id), UNIQUE INDEX UNIQ_FBF0EC9B84E3FEC4 (run_id), UNIQUE INDEX UNIQ_FBF0EC9B296CD8AE (team_id), UNIQUE INDEX UNIQ_FBF0EC9BC292CD19 (team_member_id), INDEX IDX_FBF0EC9B7876E9B0 (bet_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
