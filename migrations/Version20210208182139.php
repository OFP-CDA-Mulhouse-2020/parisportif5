 ...
 */
final class Version20210208182139 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bet_saved (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, designation VARCHAR(255) NOT NULL, amount INT NOT NULL, odds NUMERIC(10, 2) NOT NULL, gains INT NOT NULL, is_winning TINYINT(1) DEFAULT NULL, bet_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', bet_category_name VARCHAR(255) NOT NULL, competition_name VARCHAR(255) NOT NULL, competition_start_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', competition_country VARCHAR(255) NOT NULL, competition_sport_name VARCHAR(255) NOT NULL, competition_sport_country VARCHAR(255) NOT NULL, run_name VARCHAR(255) DEFAULT NULL, run_event VARCHAR(255) DEFAULT NULL, run_start_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', team_name VARCHAR(255) DEFAULT NULL, team_country VARCHAR(255) DEFAULT NULL, member_last_name VARCHAR(255) DEFAULT NULL, member_first_name VARCHAR(255) DEFAULT NULL, member_country VARCHAR(255) DEFAULT NULL, INDEX IDX_D6A97971A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
