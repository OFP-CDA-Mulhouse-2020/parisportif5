 ...
 */
final class Version20210210163942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bet (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, bet_category_id INT NOT NULL, competition_id INT NOT NULL, run_id INT DEFAULT NULL, team_id INT DEFAULT NULL, team_member_id INT DEFAULT NULL, designation VARCHAR(255) NOT NULL, amount INT NOT NULL, odds NUMERIC(10, 2) NOT NULL, is_winning TINYINT(1) DEFAULT NULL, bet_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_FBF0EC9BA76ED395 (user_id), INDEX IDX_FBF0EC9B7876E9B0 (bet_category_id), INDEX IDX_FBF0EC9B7B39D312 (competition_id), INDEX IDX_FBF0EC9B84E3FEC4 (run_id), INDEX IDX_FBF0EC9B296CD8AE (team_id), INDEX IDX_FBF0EC9BC292CD19 (team_member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bet_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, allow_draw TINYINT(1) NOT NULL, target VARCHAR(7) NOT NULL, on_competition TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bet_saved (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, designation VARCHAR(255) NOT NULL, amount INT NOT NULL, odds NUMERIC(10, 2) NOT NULL, gains INT NOT NULL, is_winning TINYINT(1) DEFAULT NULL, bet_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', bet_category_name VARCHAR(255) NOT NULL, competition_name VARCHAR(255) NOT NULL, competition_start_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', competition_country VARCHAR(2) NOT NULL, competition_sport_name VARCHAR(255) NOT NULL, competition_sport_country VARCHAR(2) NOT NULL, run_name VARCHAR(255) DEFAULT NULL, run_event VARCHAR(255) DEFAULT NULL, run_start_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', team_name VARCHAR(255) DEFAULT NULL, team_country VARCHAR(2) DEFAULT NULL, member_last_name VARCHAR(255) DEFAULT NULL, member_first_name VARCHAR(255) DEFAULT NULL, member_country VARCHAR(2) DEFAULT NULL, INDEX IDX_D6A97971A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE billing (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, postcode VARCHAR(255) NOT NULL, country VARCHAR(2) NOT NULL, designation VARCHAR(255) NOT NULL, order_number INT NOT NULL, invoice_number INT NOT NULL, amount INT NOT NULL, commission_rate NUMERIC(10, 4) NOT NULL, issue_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivery_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', operation_type VARCHAR(6) NOT NULL, INDEX IDX_EC224CAAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE competition (id INT AUTO_INCREMENT NOT NULL, sport_id INT NOT NULL, name VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', country VARCHAR(2) NOT NULL, min_runs INT NOT NULL, max_runs INT DEFAULT NULL, INDEX IDX_B50A2CB1AC78BCF8 (sport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE language (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(2) NOT NULL, country VARCHAR(2) NOT NULL, code VARCHAR(5) NOT NULL, date_format VARCHAR(50) NOT NULL, time_format VARCHAR(50) NOT NULL, capital_time_zone VARCHAR(32) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, place VARCHAR(255) NOT NULL, time_zone VARCHAR(32) NOT NULL, country VARCHAR(2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `member` (id INT AUTO_INCREMENT NOT NULL, member_role_id INT NOT NULL, member_status_id INT NOT NULL, team_id INT NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, country VARCHAR(2) NOT NULL, odds NUMERIC(10, 2) NOT NULL, INDEX IDX_70E4FA7869F79538 (member_role_id), INDEX IDX_70E4FA782BDFD678 (member_status_id), INDEX IDX_70E4FA78296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE run (id INT AUTO_INCREMENT NOT NULL, competition_id INT NOT NULL, location_id INT NOT NULL, name VARCHAR(255) NOT NULL, event VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_5076A4C07B39D312 (competition_id), INDEX IDX_5076A4C064D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sport (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, country VARCHAR(2) NOT NULL, run_type VARCHAR(7) NOT NULL, individual_type TINYINT(1) NOT NULL, collective_type TINYINT(1) NOT NULL, min_teams_by_run INT NOT NULL, max_teams_by_run INT DEFAULT NULL, min_members_by_team INT NOT NULL, max_members_by_team INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, sport_id INT NOT NULL, name VARCHAR(255) NOT NULL, country VARCHAR(2) NOT NULL, odds NUMERIC(10, 2) NOT NULL, INDEX IDX_C4E0A61FAC78BCF8 (sport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, wallet_id INT NOT NULL, language_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, civility VARCHAR(60) DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, billing_address VARCHAR(255) NOT NULL, billing_city VARCHAR(255) NOT NULL, billing_postcode VARCHAR(255) NOT NULL, billing_country VARCHAR(2) NOT NULL, birth_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', time_zone_selected VARCHAR(32) NOT NULL, deleted_status TINYINT(1) NOT NULL, deleted_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', suspended_status TINYINT(1) NOT NULL, suspended_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', activated_status TINYINT(1) NOT NULL, activated_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_verified TINYINT(1) NOT NULL, newsletters TINYINT(1) NOT NULL, identity_document VARCHAR(255) NOT NULL, residence_proof VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649712520F3 (wallet_id), INDEX IDX_8D93D64982F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE bet_saved ADD CONSTRAINT FK_D6A97971A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bet_saved DROP FOREIGN KEY FK_D6A97971A76ED395');
        ...
        $this->addSql('DROP TABLE bet_saved');
